function [Hr, F, cluster] = NF_group_4(H_beam, K , rf_num , n ,d,r_circle_min, r_circle_max,fc,sigma_aod, L, kappa, w_near_reshape)
% 不采用reduce,则需要设置初始的射频链数
% 仿照Ruicheng_Jiao的代码写
% 其中预编码矩阵参考Bichai_Wang的reduce_RF写；

% H_to_group_4 = H_mul_user*conj(w_near_reshape); % K*Q
