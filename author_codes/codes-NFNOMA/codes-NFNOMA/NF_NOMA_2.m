function [SE,EE,ite,power] = NF_NOMA_2(H,Fi,setf,K,rf_num,sigma2,P,Imax,Rmin)
...
%     Rmin = 0.01;
    ...
    [power,sume] = fmincon(@(power)(myfun_NF(power,H,Fi,A,C,setf,K,rf_num,sigma2)),p0,A0,b0,[],[],lb,ub,[],options);
