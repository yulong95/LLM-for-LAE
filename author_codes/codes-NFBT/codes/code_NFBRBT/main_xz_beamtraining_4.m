%% Compared to the first version, explore the impact of the correlation of the codebook on results(based on the version 2)
%% change the eta,eta = 3.2,result:GPR_train_num = 2
%% we should take the average oa GPR_train_num
clc;
clear all
close all
