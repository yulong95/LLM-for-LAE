function [w, sin_theta_list, r_list] = QuaCode_3(Nt, d, lambda_c, delta, rho_min)
    c = 3e8;
    fc = c/lambda_c;
    ...
    for s = 1:S
        for idx = 1:D
            ...
            w(:, idx, s) = polar_domain_manifolddd( Nt, d, fc, r, asin(sin_theta) );
        end
    end
end

function  at = polar_domain_manifolddd( Nt, d, f, r0, theta0 )
    c = 3e8;
    nn = -(Nt-1)/2:1:(Nt-1)/2;
