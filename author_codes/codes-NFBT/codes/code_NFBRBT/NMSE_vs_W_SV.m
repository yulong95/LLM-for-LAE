...
save('NMSE_vs_W_SV.mat','W_num','NMSE_OMP','NMSE_ML','NMSE_LMMSE','NMSE_GPR_exp','NMSE_GPR');
...
plot(W_num,NMSE_GPR_J0,'-r>','LineWidth',1.5,'Color',C(2,:));
plot(W_num,NMSE_GPR,'-d','LineWidth',1.5,'Color',C(1,:));

legend('MAS-OMP','MAS-ML','SeLMMSE','SBR (${\bf \Sigma} = {\bf \Sigma}_{\rm bes}$)','SBR (${\bf \Sigma} = {\bf \Sigma}_{\rm cov}$)','FontSize',12,'Interpreter','latex');
