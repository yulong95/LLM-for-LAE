function [mu,cor,index_A,h_o,kmax] = GPR_beamtraining_nearfield_ei_ceshi(Kernal,sigma2,Observe_step,S,max_GPR_iter,Gain_vector)
    ...
    if aa == 1
       ...
       [h_o_max_value,h_o_max_index] = max(h_o);
        ...
        for bb =1:Candidate_num
            ...
            % Candidate_value(bb) = abs(mu_temp(bb)) + sqrt(nu*taut(aa)) * abs(Cov_temp(bb));
        ...
        kmax = Candidate_index(maxEIIndex,:);
    end
