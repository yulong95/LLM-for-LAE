%% Compared to the version 1, try to find the optimal overhead(based on the version 2)
clc;
clear all
close all
...
% Generate the integer index from 1 to S
...
figure;
hold on
plot(x,abs(Gain_vector),'ms-', 'Linewidth', 1.6)
grid on;
box on;
