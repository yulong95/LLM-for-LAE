...
for t = 1:sample
   ...
   for s = 1:length(SNR_dB)
    ...
    max_GPR_iter = S;
    [mu_3,cor_3,index_A_3,h_o_3,kmax_3] = GPR_beamtraining_3_2(Kernal_SV_mean,SNR,1,S,max_GPR_iter,DFT,Gain_vector,i_max);
    mu_baseline = 0;
    for i = 1:S
    ...
    array_gain_far_GPR= abs(DFT(GPR_index,:)*H)^2;
